...
fullfile('data', sprintf('cifar-%s', opts.modelType)) ;
...
switch opts.modelType
  ...
  case 'min'
    net =cnn_cifar_init_mnin('networkType', opts.networkType) ;      
  case 'resnets'
...
switch lower(opts.networkType)
  ...
  case 'dagnn'
    bopts = struct('numGpus', numel(opts.numGpus)) ;
...
set = cat(2, sets{:});
% ==========================================================ATTENTION use in 45k/5k validation=====================================================
        %set= [ones(1,45000) 3*ones(1,5000) 2*ones(1,10000)];
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
